...
def main(argv):
	...
	try:
		...
		print('Run_SVM.py -C <penalty> -w <fit/pred/eval> -o <preprocessed_object> -p <pred_input>')
		sys.exit(2)
	for opt, arg in opts:
		if opt == '-h':
			print("[Command]: Run_SVM.py -C <penalty> -w <fit/pred/eval> -o <preprocessed_object> -p <pred_input>" + "\n\n" +
					"Example:" + "\n\n" + 
